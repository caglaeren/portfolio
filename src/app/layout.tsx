...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><defs><linearGradient id='g' x1='0%25' y1='0%25' x2='100%25' y2='100%25'><stop offset='0%25' style='stop-color:%238B5CF6'/><stop offset='100%25' style='stop-color:%23EC4899'/></linearGradient></defs><rect x='10' y='10' width='80' height='80' rx='18' fill='url(%23g)'/><text y='50' x='50' text-anchor='middle' dominant-baseline='central' font-size='58' fill='white' font-weight='bold' font-family='sans-serif'>Ç</text></svg>",
  },
  openGraph: {
    title: "Tuğba Çağla EREN - AI & Data Science",
